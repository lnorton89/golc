...
//   - internal/scriptsdk.CheckDrift (08-03-PLAN.md): the identical
//     read-only comparison for the generated typed GOLC SDK
//     (golc.d.ts/golc-runtime.ts) -- one generation discipline, two
//     registries.
...
func runProjectCheck(root string) Result {
	...
	scriptsdkChanged, scriptsdkErr := scriptsdk.CheckDrift(root)
	if scriptsdkErr != nil {
