//go:build windows && !native_webview2loader && golc_dialog_proof_overlay
...
import (
	...
	"github.com/lnorton89/golc/support/webview2cdp"
...
func createCoreWebView2EnvironmentWithOptions(browserExecutableFolder, userDataFolder string, environmentCompletedHandle *iCoreWebView2CreateCoreWebView2EnvironmentCompletedHandler, additionalBrowserArgs string) error {
	additionalBrowserArgs, userDataFolder = webview2cdp.Resolve(os.Getenv, additionalBrowserArgs, userDataFolder)
	e := &environmentCreatedHandler{originalHandler: environmentCompletedHandle}
