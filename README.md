...
| `mage Govulncheck` | Runs `govulncheck` over every project Go package with the project-local pinned toolchain, reporting known vulnerabilities in the module's dependency graph. |
