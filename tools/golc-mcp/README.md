...
| `golc_list_mage_targets` | All ten shared Mage descriptors; the PR record includes configured entrypoint, authority keys, ordered steps, arguments, network policy, and mutation policy |
