...
- [ ] 13-26-PLAN.md — Ten-file Art-Net and diagnostics migration (wave 7)
- [ ] 13-27-PLAN.md — Fourteen-file Scripts/Monaco migration in bounded tasks (wave 7)
- [ ] 13-28-PLAN.md — Ten-file generic MIDI mapping/pickup migration (wave 7)
- [ ] 13-29-PLAN.md — Ten-file hotkey and shared workspace chrome migration (wave 7)
