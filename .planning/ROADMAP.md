...
- [ ] 13-01-PLAN.md — Approve and install exact parser pins only (wave 1)
- [ ] 13-02-PLAN.md — Fail-closed DS001–DS010 checker and held-out fixtures (wave 3)
- [ ] 13-03-PLAN.md — Button, IconButton, Field, and Chip contracts (wave 3)
- [ ] 13-04-PLAN.md — Tabs and shared empty/loading/error states (wave 3)
- [ ] 13-05-PLAN.md — Twelve-file panel/header/toolbar/row primitive slice (wave 4)
...
- [ ] 13-13-PLAN.md — Dedicated Desk migration and geometry proof (wave 7)
- [ ] 13-14-PLAN.md — Bounded Operator Surface migration (wave 7)
- [ ] 13-15-PLAN.md — Independent safety, live truth, and tempo migration (wave 7)
- [ ] 13-16-PLAN.md — Inspector, overlays, error boundary, and log projection (wave 7)
...
- [ ] 13-21-PLAN.md — Strict inert manifests and deterministic token generation (wave 2)
- [ ] 13-22-PLAN.md — Six-file Dialog/ConfirmDialog public contract (wave 4)
- [ ] 13-23-PLAN.md — Nine-file scroll/tooltip/resize utilities (wave 4)
- [ ] 13-24-PLAN.md — Nine-file core shell and command rail migration (wave 7)
- [ ] 13-25-PLAN.md — Guided First Show core and five stages with exact 8px spacing (wave 7)
- [ ] 13-26-PLAN.md — Complete fourteen-file Art-Net and diagnostics migration in bounded tasks (wave 7)
- [ ] 13-27-PLAN.md — Fourteen-file Scripts/Monaco migration in bounded tasks (wave 7)
- [ ] 13-28-PLAN.md — Complete thirteen-file generic MIDI mapping/pickup migration in bounded tasks (wave 7)
- [ ] 13-29-PLAN.md — Complete eleven-file hotkey and shared workspace chrome migration in bounded tasks (wave 7)
- [ ] 13-30-PLAN.md — Pre-settle startup and token-independent ErrorBoundary backstops (wave 9)
...
- [ ] 13-35-PLAN.md — Explicit CI trigger authority and immutable artifact inspection (wave 12)
...
- [ ] 13-40-PLAN.md — Six-file scene timeline and layer geometry migration (wave 7)
