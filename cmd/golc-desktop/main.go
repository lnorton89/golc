...
const (
	// showPathEnvName/interfaceIndexEnvName/interfaceNameEnvName are
	// golcwails.DesktopShowPathEnvName/DesktopInterfaceIndexEnvName/
	// DesktopInterfaceNameEnvName, not second hardcoded env-var-name
	// literals (09-02-PLAN.md): this startup read and internal/wails.App's
	// RelaunchWithShow/SelectInterface relaunch spawns share exactly one
	// authority per env var name.
	showPathEnvName       = golcwails.DesktopShowPathEnvName
	interfaceIndexEnvName = golcwails.DesktopInterfaceIndexEnvName
	interfaceNameEnvName  = golcwails.DesktopInterfaceNameEnvName
